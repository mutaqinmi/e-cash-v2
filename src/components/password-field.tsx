...
export default function PasswordField(props: {label: string}){
    const [showPassword, setShowPassword] = useState(false);

    return (
        <div className="my-4 flex flex-col relative">
            <input required type={showPassword ? "text" : "password"} name={props.label.toLowerCase()} id={props.label.toLowerCase()} className="outline-none border border-gray-400 py-3 pl-3 pr-12 rounded-md peer [&::-ms-reveal]:hidden"/>
